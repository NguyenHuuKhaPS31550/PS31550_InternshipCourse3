...
var Phim = [{
  ...
  NoiDung: " là series về một kamen rider qua đường",
  ThoiDai: "Heisei",
  HinhAnh: "https://tokuvn.com/wp-content/uploads/2019/06/Kamen-Rider-Decade-2.jpg",
  DanhGia: "Bình Thường"
}, {
  TenPhim: "Kamen Rider Zio",
  NoiDung: " Series về Kamen Rider thứ 20 của thời đại heisei được gọi với cái danh ''Ma Vương'' ",
  ThoiDai: "Heisei",
  ...
  NoiDung: " Series Kamen Rider về Kiếm và những cuốn sách.",
  ThoiDai: "Reiwa",
  ...
  NoiDung: " Kamen Rider lấy chủ đề về các sinh vật trong phim kinh dị.",
  ThoiDai: "Heisei",
  ...
  NoiDung: " Kamen Rider Lấy chủ đề về đồ ngọt.",
  ThoiDai: "Reiwa",
  HinhAnh: "https://pbs.twimg.com/media/GUGQEc3aEAARkg7.jpg:large",
  DanhGia: "Hay"
}, {
  TenPhim: "Kamen Rider Ryuki",
  NoiDung: " Series Kamen Rider về cuộc chiến sinh tử giữa các rider để nhận được đièu ước cuối cùng.",
  ThoiDai: "Heisei",
  HinhAnh: "https://i.pinimg.com/originals/b9/7d/c5/b97dc50f416858c69d39f8d6859e72fd.jpg",
  DanhGia: "Hay"
}, {
  TenPhim: "Kamen Rider Gotchard",
  NoiDung: " Series Kamen Rider về giar Kim Thuật được xem là series có thể sánh ngang Saber và Ghost về độ dở và các diễn viên đóng có phần hơi đơ",
  ThoiDai: "Reiwa",
