const loai_arr = [
    { id: 1, ten_loai: "Decade", thu_tu: 0, an_hien: 1 },
...
let san_pham_arr = [
    ...
    { id: 19, ten_sp: "decade", slug: "decade-19", gia: 5209111, gia_km: 1038102, id_loai: 7, ngay: "2024-03-10", so_luong: 18, hinh: "https://gundamshop.vn/wp-content/uploads/2023/05/Bandai-Figure-Rise-Kamen-Rider-Hibiki-Decade-Model-Kits-Official-018.jpg", hot: 1, luot_xem: 761, an_hien: 1, tinh_chat: 2 },
...
const code_menu = () => {
    ...
    str += `<li> <a href="lien.html">Đăng nhập/Đăng Ký</a> </li> `;
    return `<ul>${str}</ul>`;
};
const code_1_sp = (sp) => {
    let str = `
...
const code_sp_moi = (so_sp) => {
    let sp_arr = san_pham_arr.sort(function (a, b) {
...
const code_sp_noi_bat = (so_sp) => {
    let sp_noi_bat_arr;
    sp_noi_bat_arr = san_pham_arr.filter(function (sp) {
        if (sp.hot == 1)
            return true;
        else
            return false;
